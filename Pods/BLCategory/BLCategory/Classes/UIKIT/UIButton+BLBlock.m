...
- (void)bl_handleWithBlock:(BLButtonActionBlock)actionBlock{
    
    objc_setAssociatedObject(self, &kActionKey, actionBlock, OBJC_ASSOCIATION_COPY_NONATOMIC);
    [self addTarget:self action:@selector(b_callActionBlock:) forControlEvents:UIControlEventTouchUpInside];
